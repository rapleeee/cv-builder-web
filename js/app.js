...
let firstnameElem = mainForm.firstname,
    ...
    mobilenoElem = mainForm.mobileno,
    summaryElem = mainForm.summary;

// display elements
let nameDsp = document.getElementById('fullname_dsp'),
    imageDsp = document.getElementById('image_dsp'),
    mobilenoDsp = document.getElementById('mobileno_dsp'),
...
const getUserInputs = () => {
    ...
    mobilenoElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.mobileno, 'Phone Number'));
...
const displayCV = (userData) => {
    ...
    mobilenoDsp.innerHTML = userData.mobileno;
